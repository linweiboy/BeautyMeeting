...
class IntroductionCell: UITableViewCell,ReusableView, ProtocolBorderLineView  {
  ...
  override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
    ...
    newsTitleLB.decorateStyleOfLB(title: "沈阳分公司", textColor: UIColor.black, textFont: 12.ratioHeight)
  ...
  func showData(_ title:String) {
    newsTitleLB.text = title
