...
class DailyReadCell: UITableViewCell, ReusableView, ProtocolBorderLineView {
  ...
  override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
    ...
    newsTitleLB.decorateStyleOfLB(title: "几番风雨匆匆春又归去", textColor: UIColor.black, textFont: 12.ratioHeight)
